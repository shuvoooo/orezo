...
<body>
									...
									<ul class="sub-menu">
										...
										<li><a href="#new-demo.html">Added New Demo</a>
											<ul class="sub-menu">
												...
												<li><a href="revulation-slider.html">Revulation Slider One</a></li>
												<li><a href="revulation-slider-2.html">Revulation Slider Two</a></li>
								...
								<div class="slider_text">
									...
									<div class="slider_button pt-5 d-flex">
										<div class="button">
											...
											<a class="active" href="#">IT Services <i class="fa fa-long-arrow-right"></i></a>
										</div>
									</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-6">
					<div class="techno_flipbox mb-30">
						...
						<div class="techno_flipbox_back " style="background-image:url({{asset('assets/images/feature1.jpg')}});">
							<div class="techno_flipbox_inner">		
								<div class="flipbox_title">
				...
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-6">
					<div class="techno_flipbox mb-30">
						...
						<div class="techno_flipbox_back " style="background-image:url({{asset('assets/images/feature2.jpg')}});">
							<div class="techno_flipbox_inner">		
								<div class="flipbox_title">
									<h3>Interior Design</h3>
								</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-12 col-xs-6">
					<div class="techno_flipbox mb-30">
						...
						<div class="techno_flipbox_back " style="background-image:url({{asset('assets/images/feature3.jpg')}});">
							<div class="techno_flipbox_inner">		
								<div class="flipbox_title">
	...
	<!--==================================================-->
	<div class="team_area pt-80 pb-75" style="background-image:url({{asset('assets/images/team-bg2.jpg')}})"; >
		<div class="container">
			<div class="row">
				<!-- Start Section Tile -->
				<div class="col-lg-9">
						...
						<div class="case_study_list owl-carousel curosel-style">
								...
								<div class="single_case_study">
									<div class="single_case_study_inner">
										<div class="single_case_study_thumb">
											<a href="#"><img src="{{asset('assets/images/galery/2.jpg')}}" alt="" /></a>
										</div>
									</div>
							...
							<div class="col-lg-12 pdn_0">
								<div class="single_case_study">
									<div class="single_case_study_inner">
										<div class="single_case_study_thumb">
											<a href="#"><img src="{{asset('assets/images/galery/1.jpg')}}" alt="" /></a>
										</div>
									</div>
									<div class="single_case_study_content">
										<div class="single_case_study_content_inner">
							...
							<div class="col-lg-12 pdn_0">
								<div class="single_case_study">
									<div class="single_case_study_inner">
										<div class="single_case_study_thumb">
											<a href="#"><img src="{{asset('assets/images/galery/8.jpg')}}" alt="" /></a>
										</div>
									</div>
									<div class="single_case_study_content">
										<div class="single_case_study_content_inner">
							...
							<div class="col-lg-12 pdn_0">
								<div class="single_case_study">
									<div class="single_case_study_inner">
										<div class="single_case_study_thumb">
											<a href="#"><img src="{{asset('assets/images/galery/3.jpg')}}" alt="" /></a>
										</div>
									</div>
									<div class="single_case_study_content">
										<div class="single_case_study_content_inner">
							...
							<div class="col-lg-12 pdn_0">
								<div class="single_case_study">
									<div class="single_case_study_inner">
										<div class="single_case_study_thumb">
											<a href="#"><img src="{{asset('assets/images/galery/4.jpg')}}" alt="" /></a>
										</div>
									</div>
									<div class="single_case_study_content">
										<div class="single_case_study_content_inner">
							...
							<div class="col-lg-12 pdn_0">
								<div class="single_case_study">
									<div class="single_case_study_inner">
										<div class="single_case_study_thumb">
											<a href="#"><img src="{{asset('assets/images/galery/5.jpg')}}" alt="" /></a>
										</div>
									</div>
									<div class="single_case_study_content">
										<div class="single_case_study_content_inner">
							...
							<div class="col-lg-12 pdn_0">
								<div class="single_case_study">
									<div class="single_case_study_inner">
										<div class="single_case_study_thumb">
											<a href="#"><img src="{{asset('assets/images/galery/6.jpg')}}" alt="" /></a>
										</div>
									</div>
									<div class="single_case_study_content">
										<div class="single_case_study_content_inner">
							...
							<div class="col-lg-12 pdn_0">
								<div class="single_case_study">
									<div class="single_case_study_inner">
										<div class="single_case_study_thumb">
											<a href="#"><img src="{{asset('assets/images/galery/7.jpg')}}" alt="" /></a>
										</div>
									</div>
									<div class="single_case_study_content">
										<div class="single_case_study_content_inner">
											<h2><a href="#">Photoshop Designer</a></h2>
	...
	<!--==================================================-->
	<div class="call_do_action pt-85 pb-130 bg_color" style="background-image:url({{asset('assets/images/call-bg.png')}})" >
		<div class="container">
			<div class="row">
				<div class="col-lg-9">
								...
								<div class="single_testimonial mt-3 mb-5">
									<div class="single_testimonial_content">
										...
										<div class="single_testimonial_thumb mt-2 mr-3">
											<img src="{{asset('assets/images/testi1.jpg')}}" alt="" />
										</div>
							...
							<div class="col-lg-12">
								<div class="single_testimonial mt-3 mb-5">
									<div class="single_testimonial_content">
										...
										<div class="single_testimonial_thumb mt-2 mr-3">
											<img src="{{asset('assets/images/testi2.jpg')}}" alt="" />
										</div>
										<div class="single_testimonial_content_title mt-4">
											<h4>Israt Jahan</h4>
											<span>Developer</span>
							...
							<div class="col-lg-12">
								<div class="single_testimonial mt-3 mb-5">
									<div class="single_testimonial_content">
										...
										<div class="single_testimonial_thumb mt-2 mr-3">
											<img src="{{asset('assets/images/testi3.jpg')}}" alt="" />
										</div>
										<div class="single_testimonial_content_title mt-4">
											<h4>Abrham Khan</h4>
	...
	<!--==================================================-->
	<div class="contact_area pt-85 pb-90" style="background-image:url({{asset('assets/images/bg-cnt.jpg')}})" >
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="single_blog mb-4">
						<div class="single_blog_thumb pb-4">
							<a href="blog-details.html"><img src="{{asset('assets/images/blog1.jpg')}}" alt="" /></a>
						</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="single_blog mb-4">
						<div class="single_blog_thumb pb-4">
							<a href="blog-details.html"><img src="{{asset('assets/images/blog2.jpg')}}" alt="" /></a>
						</div>
						<div class="single_blog_content pl-4 pr-4">
							<div class="techno_blog_meta">
								<a href="#">Techno </a>
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="single_blog mb-4">
						<div class="single_blog_thumb pb-4">
							<a href="blog-details.html"><img src="{{asset('assets/images/blog3.jpg')}}" alt="" /></a>
						</div>
						<div class="single_blog_content pl-4 pr-4">
							<div class="techno_blog_meta">
								<a href="#">Techno </a>
